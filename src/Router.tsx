    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/convenientcategory" element={<Convenientcategory/>} ></Route>
                <Route path="/convenientmenu/:menu" element={<Convenientmenu/>}></Route>
                <Route path="/convenientpayment" element={<Convenientpayment/>}></Route>
            </Routes>        
        </Router>
    );
}
